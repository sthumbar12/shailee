<div class="conatiner-fluid" style="height:10px;background-color: #283593"></div> 
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active"><a class="nav-link" href="#"><i class="fa-solid fa-book-open"></i> New Book</a>
      </li>
     
      <li class="nav-item active">
        <a class="nav-link disabled"><i class="fa-solid fa-book"></i> old Book</a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">  
